...
// Fri Aug  2 08:54:47 2024 by ROOT version 6.32.02
// from TTree EventTree/Event data
// found on file: root://eoshome-s.cern.ch//eos/user/s/skeshri/HLT_scouting_Egamma/2024/lxplu8/CMSSW_14_0_12/src/TagAndProbe_Trigger/TagAndProbeMacros/TnP_ntuple.root
//////////////////////////////////////////////////////////

#ifndef Scouting_Efficiency_h
#define Scouting_Efficiency_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_genMuon_fromZ;   //!

   Scouting_Efficiency(TTree *tree=0);
   virtual ~Scouting_Efficiency();
...
#ifdef Scouting_Efficiency_cxx
Scouting_Efficiency::Scouting_Efficiency(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoshome-s.cern.ch//eos/user/s/skeshri/HLT_scouting_Egamma/2024/lxplu8/CMSSW_14_0_12/src/TagAndProbe_Trigger/TagAndProbeMacros/TnP_ntuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoshome-s.cern.ch//eos/user/s/skeshri/HLT_scouting_Egamma/2024/lxplu8/CMSSW_14_0_12/src/TagAndProbe_Trigger/TagAndProbeMacros/TnP_ntuple.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://eoshome-s.cern.ch//eos/user/s/skeshri/HLT_scouting_Egamma/2024/lxplu8/CMSSW_14_0_12/src/TagAndProbe_Trigger/TagAndProbeMacros/TnP_ntuple.root:/ntupler");
...
Scouting_Efficiency::~Scouting_Efficiency()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Scouting_Efficiency::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Scouting_Efficiency::LoadTree(Long64_t entry)
{
...
void Scouting_Efficiency::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("passFilterDSTMuon", &passFilterDSTMuon, &b_passFilterDSTMuon);
   ...
   fChain->SetBranchAddress("genMuon_fromZ", &genMuon_fromZ, &b_genMuon_fromZ);
   Notify();
}

bool Scouting_Efficiency::Notify()
{
...
void Scouting_Efficiency::Show(Long64_t entry)
{
...
Int_t Scouting_Efficiency::Cut(Long64_t entry)
{
